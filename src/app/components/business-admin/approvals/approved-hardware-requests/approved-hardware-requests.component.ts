...
@Component({
  selector: 'app-approved-hardware-requests',
  templateUrl: './approved-hardware-requests.component.html',
  styleUrls: ['./approved-hardware-requests.component.css']
})
export class ApprovedHardwareRequestsComponent {
  isLoading: boolean[] = []; 
