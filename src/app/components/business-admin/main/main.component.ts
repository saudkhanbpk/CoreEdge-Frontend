...
export class MainComponent {
  ...
  menus = [
    ...
    { id: 'rfq', title: 'Rfq', icon: 'request_quote', link: '/business-admin/requests', submenus: [] },
    { id: 'quote', title: 'Quote', icon: 'request_quote', link: '/business-admin/requests', submenus: [] },
